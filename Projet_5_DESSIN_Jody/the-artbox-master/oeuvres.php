...
$oeuvres = [
    [
        'id' => 1,
        'img_url' =>"img/clark-van-der-beken.png",
        'titre'=> "Dodomu",
    ...
    [
        'id' => 2,
        'img_url' =>"img/pawel-czerwinski-3.png",
    ...
    [
        'id' => 3,
        'img_url' =>"img/dan-cristian-padure.png",
    ...
    [
        'id' => 4,
        'img_url' =>"img/steve-johnson-5.png",
    ...
    [
        'id' => 6,
        'img_url' =>"img/pawel-czerwinski.png",
        'titre'=> "Chromatics",
    ...
    [
        'id' => 7,
        'img_url' =>"img/jazmin-quaynor.png",
    ...
    [
        'id' => 8,
        'img_url' =>"img/steve-johnson-6.png",
    ...
    [
        'id' => 9,
        'img_url' =>"img/victor-grabarczyk.png",
        'titre'=> "Hurricane",
    ...
    [
        'id' => 10,
        'img_url' =>"img/pawel-czerwinski-2.png",
    ...
    [
        'id' => 11,
        'img_url' =>"img/steve-johnson-2.png",
        'titre'=> "Asimilacion",
    ...
    [
        'id' => 14,
        'img_url' =>"img/steve-johnson-4.png",
        'titre'=> "Mirage",
    ...
    [
        'id' => 15,
        'img_url' =>"img/steve-johnson-3.png",
